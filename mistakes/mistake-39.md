# 39 Drag-and-Drop Vulnerabilities (dataTransfer injection)

## Problem
Deskripsi singkat masalah keamanan terkait "Drag-and-Drop Vulnerabilities (dataTransfer injection)".
