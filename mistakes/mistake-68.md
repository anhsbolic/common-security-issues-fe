# 18 Mixed Privilege UI Elements (admin & user features in one view)

## Problem
Deskripsi singkat masalah keamanan terkait "Mixed Privilege UI Elements (admin & user features in one view)".
