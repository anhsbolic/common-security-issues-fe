# 14 Unsafe Dynamic Script Insertion via createElement('script')

## Problem
Deskripsi singkat masalah keamanan terkait "Unsafe Dynamic Script Insertion via createElement('script')".
